...
<body>
	...
	<div class="tab01" id="t5">
		...
		<a href="#t4" style="width: 248px;">배송/교환/반품</a> <a href="#t5"
	...
	<div class="tab01_cont" id="goodsOpinion">
		...
		<div class="reviwe_top_box">
			<div class="poto_link hide">
				<a href="/board/best_list.asp">전체리뷰보기 &gt;</a><a href="javascript:;"
					style="margin-left: 10px;" onclick="view_photo();">포토리뷰 모아보기
					&gt;</a>
			</div>
	...
	<script type="text/javascript">
		$(document).ready(
				function() {
					$(".reviwe_top_box .reviwe_top > div.img_list span.img")
							.each(
									function(index) {
										var ahref = $(this).find("a").attr(
												"href");
										var bgurl = "url("
												+ $(this).find("a > img").attr(
														"src")
												+ ") no-repeat center center";
										$(this).find(".coverlink").attr("href",
												ahref);
										$(this).find(".coverlink").css(
												"background", bgurl);
										$(this).find(".coverlink").css(
	...
	<script type="text/javascript">
		$(document).ready(
				function() {
					$(".board_list td .img .smallimg").click(
							function() {
								$(this).parent().toggleClass("active ");
								//$(window).resize();
								$(this).next().find('.bigimg')
										.css(
												"margin-left",
												-$(this).next().find('.bigimg')
														.width() / 2);
		...
		$(window).resize(
				function() {
					$('.board_list td .img .bigimg').css("margin-left",
							-$('.board_list td .img .bigimg').width() / 2);
					$('.board_list td .img .bigimg').css("margin-top",
							-$('.board_list td .img .bigimg').height() / 2);
				});
	</script>
	<!-- <script>
        var contentHeight = ""
