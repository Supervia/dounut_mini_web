        ...
        <hr class="first_hr">
          ...
          <form id="joinForm"
            ...
            <div class="mb-3 ss">
              ...
              <input type="text" class="form-control" id="username" onkeyup="valUsername()" placeholder="아이디 입력" required>
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-3 ss">
                ...
                <input type="text" class="form-control" id="password" onkeyup="valPassword()"placeholder="비밀번호 입력"  required>
              ...
              <div class="col-md-6 mb-3 ss">
                ...
                <input type="text" class="form-control" id="rePassword" onkeyup="valRePassword()" placeholder="비밀번호 입력" required>
            ...
            <div class="mb-3 ss">
              ...
              <input type="name" class="form-control" id="name" onkeyup="valName()" placeholder="이름 입력" required>
            ...
            <div class="mb-3 ss">
              ...
              <input type="email" class="form-control" id="email" onkeyup="valEmail()" placeholder="your@example.com" required>
              <div id ="emailError" style ="display:none; color:red;"></div>
            </div>

            <div class="mb-3 ss">
              <label for="address">주소*</label>
              <input type="text" class="form-control" id="address" placeholder="주소를 입력해주세요.  ex) 서울시 강남구" required>
